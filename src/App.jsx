...
const projects = [
  {
    title: 'UniBorrow',
    description: 'University-based online platform exchange project focusing on helping students with their subject item requirements via allowing older students lend theirs in exchange for monetary profit.',
    tech: ['CSS', 'HTML', 'JavaScript', 'Supabase'],
    link: '#',
    featured: true,
  }
]
...
const skills = [
  ...
  { category: 'Tools', items: ['GitHub', 'VSCode','AWS', 'Figma'] },
]

const experience = [
  { role: 'Software Engineer', company: 'Eastern Samar State University', period: '2025 - 2026', description: 'Developed website for school project.' }
]
    ...
    <div className="min-h-screen">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-6">
            Hi, I'm <span className="bg-gradient-to-r from-violet-400 via-fuchsia-400 to-cyan-400 bg-clip-text text-transparent">Rovi Anne Legria</span>
          </h1>
          <p className="text-xl text-zinc-400 max-w-2xl mb-8 leading-relaxed">
            Aspiring full-stack developer and game developer.
          </p>
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 ml-2">
              <a href="https://github.com/Rovi-Anne" target="_blank" rel="noopener noreferrer" className="p-2 text-zinc-400 hover:text-white hover:bg-zinc-800 rounded-lg transition-all">
                <GithubIcon />
              </a>
              <a href="https://www.linkedin.com/in/rovi-anne-legria-45a178407" target="_blank" rel="noopener noreferrer" className="p-2 text-zinc-400 hover:text-white hover:bg-zinc-800 rounded-lg transition-all">
                <LinkedInIcon />
              </a>
              <a href="https://www.facebook.com/rovianne.legria.92" target="_blank" rel="noopener noreferrer" className="p-2 text-zinc-400 hover:text-white hover:bg-zinc-800 rounded-lg transition-all">
                <FacebookIcon />
              </a>
            </div>
          </div>
      ...
      <footer className="py-8 px-6 border-t border-zinc-800/50">
        <div className="max-w-5xl mx-auto flex justify-between items-center text-sm text-zinc-600">
          <span>© 2026 Rovi Anne Legria</span>
          <span>Built with VSCode and GitHub</span>
        </div>
      </footer>
    </div>
  )
